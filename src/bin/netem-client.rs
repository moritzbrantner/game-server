...
use game_server::{
    decode_demo_snapshot, decode_snapshot, decode_welcome, encode_command, encode_demo_command,
};
use std::env;
use std::error::Error;
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let final_command = encode_command(command_count, &payload)?;
    ...
    println!(
        "{{\"mode\":\"webtransport-netem-client\",\"connected\":true,\"connectMs\":{connect_ms:.3},\"rttMs\":{rtt_ms:.3},\"playerId\":{},\"connectionEpoch\":{},\"welcomeTick\":{},\"sentCommands\":{},\"finalSentSequence\":{},\"finalAppliedSequence\":{},\"receivedSnapshots\":{},\"acceptedSnapshots\":{},\"staleSnapshots\":{},\"invalidSnapshots\":{},\"firstAcceptedTick\":{},\"lastAcceptedTick\":{},\"expectationsHold\":{}}}",
        welcome.player_id,
